...
<body>
    ...
    <form action="<?php echo U();?>" method="post" class="form-horizontal">
        ...
        <div class="form-item">
            ...
            <div class="controls">
                <input type="text" class="text input-large" name="address" value="<?php echo ((isset($info["address"]) && ($info["address"] !== ""))?($info["address"]):''); ?>">            </div>
        </div>
        <div class="form-item">
            <label class="item-label">标题<span class="check-tips">（简述报修问题）</span></label>
            <div class="controls">
                <input type="text" class="text input-small" name="problem" value="<?php echo ((isset($info["problem"]) && ($info["problem"] !== ""))?($info["problem"]):''); ?>">
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">内容<span class="check-tips"></span></label>
            <div class="controls">
                <!--<input type="" class="text input-small" name="problem" value="<?php echo ((isset($info["content"]) && ($info["content"] !== ""))?($info["content"]):''); ?>">-->
